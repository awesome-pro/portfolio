...
export const PROJECTS: ProjectMeta[] = [
  ...
  },
  {
    ...
    keywords: ["LLM guardrails", "agent runtime", "OpenTelemetry", "circuit breaker", "token budget"],
    programmingLanguage: ["Python"],
    hasPage: false,
    date: "2026-04-10",
  },
  {
    ...
    keywords: ["semantic cache", "LLM cache", "FAISS", "embeddings", "sentence-transformers"],
    programmingLanguage: ["Python"],
    hasPage: false,
    date: "2026-03-15",
  },
  {
    ...
    keywords: ["multi-agent", "orchestration", "asyncio", "pipeline", "LiteLLM"],
    programmingLanguage: ["Python"],
    hasPage: false,
    date: "2026-02-20",
  },
  {
    ...
    keywords: ["agent evaluation", "LLM testing", "pass rate", "CI", "behavioral assertions"],
    programmingLanguage: ["Python"],
    hasPage: false,
    date: "2026-01-25",
  },
